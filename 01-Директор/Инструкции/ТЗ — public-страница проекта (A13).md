...
| D5 | **Триал 30 дней** | **Кратко в тексте / footer**, не hero; детали — **после перехода в Pro** (регистрация) |
...
| `meta description` | **Ведите клиентов, расписание и планы тренировок в одном сервисе. Пробный период 30 дней для новых тренеров.** | ~95 символов (§3.6.4) |
| **Primary CTA** | **«Начать бесплатно»** | href = URL из §6.3 (партнёрская `/i/{token}`) |
| Secondary | **Нет** (один primary, D2) | |
| Текст про **30 дней** | **«Новым тренерам доступен пробный период 30 дней с полным доступом к функциям сервиса. Подробные условия — после регистрации.»** | §4.6 T-TRIAL, только footer |
...
3. **Конкретика, не абстракция:** «календарь занятий», «карточка клиента», «**тренировки для клиента**» — **лучше**, чем «экосистема», «цифровизация», «комплексное решение».
...
| комплекс (без пояснения, про тренировки) | **«тренировка»** или **«шаблон тренировки»** |
| программа (про M5) | **«шаблон тренировки»** / **«назначенная тренировка»** (v2); не путать с **занятием** в календаре |
...
- **30 дней:** формулировка без двусмысленности «бесплатно навсегда»; детали условий — после перехода в Pro (D5).
...
| L3 | **Триал 30 дней** | **Только footer** (D5), не hero | «Пробный период … дней с полным доступом к функциям сервиса»; **без** «пилотной версии», цен, тарифов; подробные условия — после регистрации | ≤ 200 знаков; формулировку утверждает юрист |
...
| `meta description` | Ведите клиентов, расписание и планы тренировок в одном сервисе. Пробный период 30 дней для новых тренеров. |
| `og:title` | = title |
...
| ID | Текст |
|----|-------|
| T-TRIAL | Новым тренерам доступен пробный период 30 дней с полным доступом к функциям сервиса. Подробные условия — после регистрации. |
