...
![Шаг 1 — переход по ссылке](media/01_glavnaya_posle_ssylki.jpg)
...
![Шаг 2 — юридические документы](media/02_registratsiya_pravila.jpg)
...
![Шаг 3 — бот Телотрон Pro](media/03_registratsiya_max_bot.jpg)
...
![Шаг 4 — Passkey](media/04_registratsiya_passkey.jpg)
...
![Шаг 5 — установка на телефон](media/05_ustanovka_pro.jpg)
...
![Шаг 6 — приглашение клиента](media/06_klienty_ssylka.jpg)
...
![Шаг 7 — регистрация клиента](media/07_client_registratsiya.jpg)
...
![Шаг 8 — календарь](media/08_raspisanie.jpg)
...
1. Откройте раздел **«Тренировки»** (шаблон тренировки) или **«Планы питания»** (файл).
2. Создайте или выберите готовое.
3. **Назначьте** клиенту.

Клиент откроет план в своём приложении — не в переписке.

![Шаг 9 — шаблон тренировки](media/09_programmy_trenirovok.jpg)

*Рис. 9 — **шаблон тренировки** в разделе «Тренировки» (назначение — в карточке клиента). План питания файлом — в разделе «Планы питания».*
```{=openxml}
<w:p><w:r><w:br w:type="page"/></w:r></w:p>
```
...
![Шаг 10 — группа](media/10_gruppy.jpg)
