...
PILOT_TABLE = """| | |
|--|--|
| **Срок** | **30 дней** бесплатно · полный функционал |
...
PILOT_LIST = """- **Срок** — **30 дней** бесплатно, полный функционал
- **Оплата** — не раньше **01.08.2026**, карта на пилоте не нужна
...
def build_title_page_xml(cover_image_rid: str, site_link_rid: str) -> str:
    parts = [
        ...
        _accent_bar(),
        _centered_para(_text_run("Пилот · 30 дней бесплатно", size=24, color=COLOR_MUTED), before=200, after=80),
        _centered_para(
            (
