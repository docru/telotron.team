...
| Footer trial | …пробный период 30 дней… (см. §6.2 T-TRIAL) |

**Сейчас в `welcome.blade.php` расхождения** (привести к §6.2): lead про «питания файлами», буллеты про «файлы» вместо **конструктора тренировок** — **исправить**.
