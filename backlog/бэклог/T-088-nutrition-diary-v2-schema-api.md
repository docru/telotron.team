...
- [ ] Миграция на пустых данных; старые таблицы удалены
- [ ] Модели + сервис в `app/Modules/Nutrition/`
- [ ] Feature-тесты CRUD слота/блюда, unique constraint, photo 409/replace
- [ ] Pro `showPhoto` по новому FK (view rights без изменений)
