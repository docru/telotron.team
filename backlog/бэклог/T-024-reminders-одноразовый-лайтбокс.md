...
**Первый потребитель:** [Commerce](../../_telotron.ru/docs/Техдок/03-модули/commerce-модуль-тз-mvp.md) — лайтбокс «платные функции приостановлены» при переходе в `light`/`frozen` (один раз на эпизод заморозки). Эпик Commerce: [E-001](../эпики/E-001-commerce-модуль.md) (интеграция в [T-030](T-030-commerce-daily-debit-freeze.md)).
