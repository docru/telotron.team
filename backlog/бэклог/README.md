...
| [T-074](T-074-заключить-договор-sms-aero.md) | `backlog` · частично | Подписан локально (не в Git); юрлицо + архив до **01.08** |
...
| [T-076](T-076-pro-onboarding-устойчивость-ui-checklist-tour.md) | `backlog` · P2 | Устойчивость onboarding · хвост [T-060](../сделано/T-060-pro-onboarding-k-p.md) |
