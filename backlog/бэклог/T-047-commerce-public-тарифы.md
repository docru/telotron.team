...
> **DEC-007:** тарифов нет. Пересмотреть scope под **клиенто-день + аддоны**. Канон: [модель-монетизации](../../../_telotron.ru/docs/Бизнес-требования/00-канон-mvp/модель-монетизации-платформа.md).
