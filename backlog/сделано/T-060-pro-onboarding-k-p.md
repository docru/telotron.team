...
### 2026-07-31 · решение директора (post-done)

- Мастера К/П и связанный UX **снимаем** (не развиваем): [T-101](../в-работе/T-101-ux-volna2-pro-ia-i-audit.md) срез **A9**.
- Замена: мягкие подсказки — [T-102](../бэклог/T-102-ux-виджет-мягких-подсказок.md).
- [T-065](../бэклог/T-065-pro-onboarding-порядок-подготовка-клиент.md) — superseded (перестройка мастера не нужна).
