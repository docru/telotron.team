...
Закрытые тикеты. Статус в файле: `done`, итог в журнале.

Файлы **не удаляем** — история и ссылки из спринтов/retro.
...
| T-011 | Legal acceptance audit |
| T-012 | Legal docs v1.0 publish |
| T-013 | Age 18+ registration/profile |
