...
| Поле | Значение |
|------|----------|
| **Статус** | `in_progress` · папка: **`в-работе/`** · **код ✅** · **ops хвост** |
| **Приоритет** | P1 |
| **Спринт** | 1→4 (ops — по мере готовности env) |
| **Роль** | dev |
| **Создан** | 2026-06-14 |
...
- Код и тесты в prod; тикет остаётся в `в-работе/` до закрытия **ops** чеклиста (env, webhook MAX/TG Client).
