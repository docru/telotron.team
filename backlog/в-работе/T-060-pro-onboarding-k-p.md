...
**Тексты UI:** простой язык, ориентир — [Онбординг — инструкция для тренеров.md](../../02-Маркетолог/Инструкции/Онбординг%20—%20инструкция%20для%20тренеров.md) (маркетинг; не дублировать Word в коде).
...
> Ориентир по смыслу шагов: [Онбординг — инструкция для тренеров.md](../../02-Маркетолог/Инструкции/Онбординг%20—%20инструкция%20для%20тренеров.md) (скрины `онбординг-тренеров/01…10` — **не** копировать Word, только визуальные референсы).
...
| Вариант | Решение |
|---------|---------|
| **MVP (рекомендуется)** | Только **Lucide-иконки** + опционально **мини-скрин** 48–64px справа в карточке для `invite_client` / `schedule_or_plan` (кадры из `онбординг-тренеров/06`, `08`) |
...
- [ ] Указать, какие скрины из `онбординг-тренеров/` вставлять (если используются)
...
- [Онбординг — инструкция для тренеров.md](../../02-Маркетолог/Инструкции/Онбординг%20—%20инструкция%20для%20тренеров.md) · PDF-сборка закрыта в [T-061](../сделано/T-061-онбординг-инструкция-тренеров-pdf.md)
