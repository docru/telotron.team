...
| **Бывш. ID** | T-037 |
| **Приоритет** | P1 (stage ready ориентир **31.07–08**, prod **01.09** вместе с Commerce · DEC-005) |
...
|-------------|---------|-----------|
| **Пакет юрдокументов** [T-092](../бэклог/T-092-legal-партнёрская-программа-пакет-документов.md) | stage Partner | T-042, T-045, prod **01.09** |
| Commerce topup на stage | к **01.09** | T-040, P8 |
