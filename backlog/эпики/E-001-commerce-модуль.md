...
| Поле | Значение |
|------|----------|
| **Статус** | `in_progress` · папка: **`эпики/`** · **пересмотр под DEC-007** |
| **Бывш. ID** | T-026 |
| **Приоритет** | P1 (prod платежей ориентир **01.09** · DEC-005; модель оплаты — **DEC-007**) |
| **Спринт** | этап 1 · Пилот · спринты **2–5** + доработка модели |
...
- **Аддоны** — отдельная абонплата ([E-006](E-006-поиск-клиентов.md) и др.).
- Детали ставки и проводок — **при реализации** / пересмотре ТЗ.

Канон: [модель-монетизации-платформа](../../../_telotron.ru/docs/Бизнес-требования/00-канон-mvp/модель-монетизации-платформа.md) · [модуль-оплаты-платформа](../../../_telotron.ru/docs/Бизнес-требования/02-модули/billing/модуль-оплаты-платформа.md).
...
**Вне эпика:** оплаты клиент→тренер; [автопополнение](../идеи/commerce-автопополнение-с-карты.md). **Partner:** [E-002](E-002-partner-модуль.md).
